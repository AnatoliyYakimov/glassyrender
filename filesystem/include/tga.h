...
namespace tga
{
	...
	inline static void ReadPixel8(Type*& Buffer, Type& Red)
	{
		Red = *Buffer++;
	}

	template <typename Type>
    inline static void ReadPixel24(Type*& Buffer, Type& Red, Type& Green, Type& Blue)
	{
		Blue = *Buffer++;
		Green = *Buffer++;
		Red = *Buffer++;
	...
	template <typename Type>
    inline static void ReadPixel32(Type*& Buffer, Type& Red, Type& Green, Type& Blue, Type& Alpha)
	{
		Blue = *Buffer++;
		Green = *Buffer++;
		Red = *Buffer++;
	...
	template <typename Type>
    inline static void WritePixel8(Type*& Buffer, Type Red)
	{
		*Buffer++ = Red;
	}

	template <typename Type>
    inline static void WritePixel24(Type*& Buffer, Type Red, Type Green, Type Blue)
	{
		*Buffer++ = Red;
		*Buffer++ = Green;
		*Buffer++ = Blue;
	...
	template <typename Type>
    inline static void WritePixel32(Type*& Buffer, Type Red, Type Green, Type Blue, Type Alpha)
	{
		*Buffer++ = Red;
		*Buffer++ = Green;
		*Buffer++ = Blue;
	...
	*/
	...
	template <typename Type>
    inline void TGA::RGBPaletted(Type* InBuffer, uint8_t* ColorMap, uint8_t* OutBuffer, size_t Size)
	{
	...
	template <typename Type>
    inline void TGA::RGBAPaletted(Type* InBuffer, uint8_t* ColorMap, uint8_t* OutBuffer, size_t Size)
	{
